...
public class Room extends Location {
    ...
    /**
     * Calculates the heating cost for the given number of days for the room.
     *
     ...
     */
    public float getRoomHeatingCost(float numberOfDays, float price){
        if (numberOfDays < 0 || price < 0) {
            throw new IllegalArgumentException("Number of days and price must be non-negative.");
        }
        float energyInKWh = (heating * 60 * 60 * 24 * numberOfDays) / 3600000;
